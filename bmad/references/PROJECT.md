# 📘 Design Document — Slive : AI-Assisted Writing Software
**Version 1.0 — Reference Document**  
Stack: Svelte-5 + LiveKit · Philosophy: rigour, awareness, multimodal efficiency, multi-user isolation
...
tension_curve:
  ...
  - chapter_ref: chapter_07
    target_level: 8
```
il faut merge ces deux enormes fichiers
---
...
```html
<!-- Layout descriptor moved to a dedicated file -->
The canonical layout descriptor has been moved to: `src/interfaces/layout.html`.
Use that file as the authoritative semantic GUI description for the application.
    </panel>
